...
function getPolynom(...arg) {
  ...
  // return arg.reverse().reduce((previousValue, currentValue, index) => {
  //   previousValue.push({ x: index, y: currentValue });
  //   return previousValue;
  // }, []);
  return (x) => [...arg].reverse().reduce((previousValue, currentValue, index) => previousValue
    + currentValue * Math.pow(x, index), 0);
}
